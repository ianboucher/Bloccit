require 'rails_helper'
 ...
 RSpec.describe Api::V1::TopicsController, type: :controller do
   ...
   # We want to enable unauthenticated users to fetch topics, but not do CRUD
   context "unauthenticated user" do
     ...
     it "PUT update returns http unauthenticated" do
       put :update, id: my_topic.id, topic: {name: "Topic Name",
  ...
  #  We want to allow properly authenticated & authorized admin users to do CRUD
   ...
   context "authenticated and authorized users" do
     ...
     describe "PUT update" do
       before { put :update, id: my_topic.id, topic: {name: @new_topic.name,
     ...
     describe "POST create" do
       before { post :create, topic: {name: @new_topic.name,
         description: @new_topic.description} }
