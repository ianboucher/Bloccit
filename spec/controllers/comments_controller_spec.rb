...
RSpec.describe CommentsController, type: :controller do
  ...
  context "guest user" do
    ...
    describe "DELETE destroy" do
      # check that comment still exists after delete attempt
  ...
  context "member user doing CRUD on a comment they don't own" do
    ...
    describe "DELETE destroy" do
      ...
      # passing format: :js to the delete method simulates a .js request to the
      # controller
  ...
  context "member user doing CRUD on a comment they own" do
    ...
    describe "POST create" do
      it "increases the number of comments by 1" do
        expect{ post :create, format: :js, post_id: my_post.id,
          comment: {body: RandomData.random_sentence} }.to change(Comment,:count).by(1)
      end
