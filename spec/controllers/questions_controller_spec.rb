...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it "returns http success" do
      # {id: my_question.id} is passed to the 'params' hash as a parameter
  ...
  describe "GET edit" do
     ...
     # Check that edit assigns the correct question to be updated to @question
   ...
   describe "DELETE destroy" do
     ...
     it "deletes the question" do
       ...
       # After destroy is called on question ID#, look for the question with the same ID
